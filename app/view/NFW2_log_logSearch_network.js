...
Ext.define('NFW2.view.NFW2_log_logSearch_network', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_log_logsearch_network',

    requires: [
        'NFW2.view.NFW2_log_logSearch_networkViewModel',
        'Ext.form.Panel',
        'Ext.form.Label',
        'Ext.button.Button',
        'Ext.form.field.Date',
    ...
    viewModel: {
        type: 'nfw2_log_logsearch_network'
    },
    id: 'NFW2_log',
    minHeight: 300,
    ...
    onButtonClick: function(button, e, eOpts) {
        ...
        var store = Ext.data.StoreManager.lookup('store_log_network');
        ...
        _search_params['schema_name'] = Ext.encode('NETWORK');
        ...
        if(Ext.getCmp("dis_mode").getValue() === "display"){
            ...
            var fileName = Ext.Date.format(new Date(), 'Ymd')+"_NETWORK.xlsx";
            var path = '/mnt/ramdisk/do/F3view/nodeapps/deploy/public/javascripts/attachments/';

            var _condition = {
                schema_name: Ext.encode('NETWORK'),
    ...
    onPanelAfterRender: function(component, eOpts) {
        ...
        request_helper.xmlrpc_call_JsonP(
            ...
            function(response){
                ...
                var r_event = [];
                var a_list = ["인터페이스","Multipath","L2TP","Checker","VRRP"];
                var _a_list = ['inter','multi','l2','checker','vrrp'];
    ...
    tag_validate: function(value) {
        ...
        }else if(val[0] !== __zen('desc').toLowerCase() && val[0] !== __zen('summary')){
            return false;
        }
        Ext.getCmp("err_msg").hide();
        return true;
