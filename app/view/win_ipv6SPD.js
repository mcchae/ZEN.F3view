...
Ext.define('NFW2.view.win_ipv6SPD', {
    extend: 'Ext.window.Window',
    alias: 'widget.win_ipv6spd',

    requires: [
        'NFW2.view.win_ipv6SPDViewModel',
        'Ext.form.Panel',
        'Ext.grid.Panel',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                cellclick: 'onGrid_destCellClick',
                            ...
                            items: [
                                {
                                    ...
                                    handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                        ...
                                        Ext.getCmp("win_ipv6SPD").get_obj_info(cid,otype,"grid_setobj",rowIndex,(record.data.xname===undefined)?record.data.name:record.data.xname,flag);
    ...
    onGrid_destCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        var cid = record.data.cid;
        var otype = record.data.otype;
        var tmptd = Ext.get(td).query("ul")[1];
        var flag = (tmptd !== undefined)?false:true;
    ...
    onGrid_svcCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        var cid = record.data.cid;
        var otype = record.data.otype;
        var tmptd = Ext.get(td).query("ul")[1];
        var flag = (tmptd !== undefined)?false:true;
    ...
    init_fw_spd_ipv6: function(edit, uid) {
        ...
        var _getprofile = [
            ...
            {    collection: 'with_cid',   cond:{'_kind':'object_ipv6_header'},    sort:'name',    fields:{'@cid':1,'name':1,'_id':0},   ver:0},
        ...
        request_helper.xmlrpc_call_JsonP('ftuctrl','getMultiObjs',xparams,
                                         function(response){
                                             ...
                                             for(var i=0; i<response.length; i++){
                                                 ...
                                                 if(__cond === "ips")					{	 Ext.getCmp("ips").bindStore(__store);}
                                                 else if(__cond === "object_ipv6_header")				{	 Ext.getCmp("header").bindStore(__store);}
    ...
    setWinState_policy: function(btn) {
        if(btn==="no"){
            ...
            Ext.getCmp("fm_v6spd").getForm().reset();
            ...
            return false;
                ...
                request_helper.xmlrpc_call_JsonP(
                    ...
                    function(response){
                       ...
                       // console.log(store.data.items[rowIndex]);
