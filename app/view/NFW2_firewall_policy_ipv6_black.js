...
Ext.define('NFW2.view.NFW2_firewall_policy_ipv6_black', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_firewall_policy_ipv6_black',

    requires: [
        'NFW2.view.NFW2_firewall_policy_ipv6_blackViewModel',
    ...
    viewModel: {
        type: 'nfw2_firewall_policy_ipv6_black'
    },
    cls: 'zen_body',
    id: 'white_black_ip',
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    validator: function(value) {
                        ...
                        if(value.indexOf("/") !== -1){
                            ...
                            if(ValidIPv6(a_ip[0])===false){ return ValidIP("IP "); }
                            if(a_ip[1].indexOf(".") !== -1){ return ValidIP("Prefix "); }
                            if(a_ip[1] < 8 || a_ip[1] > 32){ return ValidIP("Prefix "); }

                        }else{
                            if(ValidIPv6(value)===false){ return ValidIP("IP "); }
                        }
                        return true;
                    },
                    id: 'b_search_ipv6',
                    ...
                    listeners: {
                        errorchange: 'onB_search_ipv6ErrorChange',
                        keydown: 'onB_search_ipv6Keydown',
                        render: 'onB_search_ipv6Render'
                    }
                },
                {
                    xtype: 'button',
                ...
                },
                {
                    ...
                    enableKeyEvents: true,
                    listeners: {
                        keydown: 'onB_search_desc_v6Keydown',
                        render: 'onB_search_desc_v6Render'
                    }
                },
                {
                    xtype: 'button',
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                xtype: 'displayfield',
                                id: 'zen_fw_black_ipv6_disp_total',
                                labelAlign: 'right',
                                labelSeparator: ' ',
                                labelWidth: 90,
                    ...
                    },
                    {
                        ...
                        listeners: {
                            celldblclick: 'onB_tbl_listv4CellDblClick'
                        }
                    }
                ]
            };
    ...
    onButtonClick2: function(button, e, eOpts) {
        ...
        var tbl = Ext.getCmp("b_tbl_listv6");
    ...
    onButtonClick3: function(button, e, eOpts) {
        ...
        Ext.MessageBox.confirm(__weguardia,get_msg('conf_del_all'), function(btn){
            if(btn === "yes"){
                ...
                var _param = {
                    basename: Ext.encode("network_white_black_ip"),
                    key: Ext.encode({'type':'black','ip_ver':'ipv6'})
                };
    ...
    onButtonClick7: function(button, e, eOpts) {
        ...
        var fileName = "WeGuardia_Black_IPv6";
        ...
        var _params = {
            ...
            cond: Ext.encode({'type':'black','ip_ver':'ipv6'}),
    ...
    onButtonToggle: function(button, pressed, eOpts) {
        if(pressed){
            Ext.getCmp("upform_black").show();
        }else{
            Ext.getCmp("upform_black").hide();
        }
    },
    ...
    onButtonClick5: function(button, e, eOpts) {
        ...
        var form = Ext.getCmp('upform_black').getForm();
            ...
            form.submit({
                ...
                success: function(fp, o) {
                    ...
                    var _params = {
                        ...
                        opt: Ext.encode({'type':'black','ip_ver':'ipv6'})
                    };
                    showLoadMask();
    ...
    onB_search_ipv6ErrorChange: function(labelable, error, eOpts) {
        prt_errMsg_label(error,'err_valid');
    },

    onB_search_ipv6Keydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            var ip = textfield;
            ...
            if(ip.getValue().indexOf("/") !== -1){
                ...
                if(ValidIPv6(a_ip[0])===false){ prt_errMsg_label(ValidIP("IP "), "err_valid"); return false; }
                ...
                if(ValidIPv6(ip.getValue())===false){ prt_errMsg_label(ValidIP("IP"), "err_valid"); return false; }
            }
            ...
            _store.getProxy().setExtraParam('cond',Ext.encode({'ip_ver':'ipv6','type':'black'}));
            ...
            Ext.getCmp("b6_reset").show();
        }
    },

    onB_search_ipv6Render: function(component, eOpts) {
        component.emptyText = __zen('ipv6');
        component.applyEmptyText();
    },

    onButtonClick: function(button, e, eOpts) {
        var ip = Ext.getCmp("b_search_ipv6");
    ...
    onB_search_desc_v6Keydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            var desc = textfield;
            ...
            _store.getProxy().setExtraParam('cond',Ext.encode({'ip_ver':'ipv6','type':'black','desc':{'$regex':'.*'+desc.getValue()+'.*','$options':'imxs'}}));
            _store.getProxy().setExtraParam('sort_list',Ext.encode([['ip_first',1],['ip_last',1]]));
            _store.loadPage(1);
    ...
    onB_search_desc_v6Render: function(component, eOpts) {
        component.emptyText = __zen('desc');
        component.applyEmptyText();
    },

    onButtonClick1: function(button, e, eOpts) {
        var desc = Ext.getCmp("b_search_desc_v6");
    ...
    onButtonClick4: function(button, e, eOpts) {
        ...
        Ext.getCmp("b_search_ipv6").reset();
        Ext.getCmp("b_search_desc_v6").reset();

        Ext.getCmp("b6_reset").hide();
    },

    onB_tbl_listv4CellDblClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        var win = Ext.create("NFW2.view.win_white_black_ip",{
            edit: "edit",
            type_wb : "Black",
            type : "IPv6",
    ...
    fm_reset: function() {
        Ext.getCmp("fm_black_v6").getForm().reset();
    },
            ...
            function(response){
                ...
                request_helper.xmlrpc_call_JsonP(
                    ...
                    function(response){
                        ...
                        if(max_count){
                            Ext.getCmp("zen_fw_black_ipv6_disp_total").setValue(response.total+'/'+max_count);
                        }
                    }
                );
            }
