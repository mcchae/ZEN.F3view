...
Ext.define('NFW2.view.NFW2_firewall_object_ip_ipv6_addressGroup', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_firewall_object_ip_ipv6_addressgroup',

    requires: [
        'NFW2.view.NFW2_firewall_object_ip_ipv6_addressGroupViewModel',
    ...
    viewModel: {
        type: 'nfw2_firewall_object_ip_ipv6_addressgroup'
    },
    cls: 'zen_body',
    id: 'ipv6Group',
            ...
            items: [
                ...
                },
                {
                    ...
                    validator: function(value) {
                        ...
                        if(validIPv6Form(value)===false){ return ValidIP("IP "); }
                        return true;
                    },
                    id: 's_mip',
                    emptyText: '그룹 멤버 IPv6',
                    enableKeyEvents: true,
                    listeners: {
            ...
            config = {
                items: [
                    ...
                    },
                    {
                        ...
                        title: '',
                        columnLines: true,
                        store: 'store_object_ipv6_group_list',
                        columns: [
                            {
                                xtype: 'gridcolumn',
                                width: 60,
    ...
    onButtonClick: function(button, e, eOpts) {
        ...
        var win = Ext.create('NFW2.view.win_ipv6_group');
        win.show();
    },
                ...
                if(btn === "yes"){
                    ...
                    request_helper.xmlrpc_call_JsonP(
                        ...
                        function(response){
                            ...
                            Ext.getCmp("ipv6Group").onResetClick();
                        }
                    );
                }
            });
    ...
    onButtonClick5: function(button, e, eOpts) {
        ...
        Ext.getCmp("btn_ipv6_group_reset").show();
    },
    ...
    onS_mipKeydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            ...
            if(validIPv6Form(textfield.getValue())===false){
                prt_errMsg(ValidIP("IP "), "err_valid");
                Ext.getCmp("s_mip").focus();
                return false;
            }
    ...
    onS_mipRender: function(component, eOpts) {
        component.emptyText = __zen('group_mem_v6');
        component.applyEmptyText();
    },

    onButtonClick4: function(button, e, eOpts) {
        var ip = Ext.getCmp("s_mip").getValue();
        if(ip===""){ return false; }
    ...
    onResetClick: function(button, e, eOpts) {
        ...
        _store.currentPage = 1;
        Ext.getCmp("ipv6Group").store_load();

        Ext.getCmp("btn_ipv6_group_reset").hide();
    ...
    onGrid_listCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        if(cellIndex === 3){
            ...
            var store = Ext.data.StoreManager.lookup("store_object_ipv6_group_list");
