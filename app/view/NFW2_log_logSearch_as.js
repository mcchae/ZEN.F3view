...
Ext.define('NFW2.view.NFW2_log_logSearch_as', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_log_logsearch_as',

    requires: [
        'NFW2.view.NFW2_log_logSearch_asViewModel',
        'Ext.form.Panel',
        'Ext.form.Label',
        'Ext.button.Button',
        'Ext.form.field.Date',
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    xtype: 'container',
                    listeners: {
                        beforerender: 'onDep_tooltipBeforeRender'
                    }
                },
                {
                    xtype: 'container',
    ...
    onDep_tooltipBeforeRender: function(component, eOpts) {
        component.add({
            xtype: 'container',
            hidden: true,
            id: 'dep_tooltip',
    ...
    onButtonClick: function(button, e, eOpts) {
        ...
        var store = Ext.data.StoreManager.lookup('store_log_as');
        ...
        _search_params['schema_name'] = Ext.encode('AS');
