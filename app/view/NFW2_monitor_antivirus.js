...
Ext.define('NFW2.view.NFW2_monitor_antivirus', {
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            doRefresh: function() {
                                                ...
                                                if (me.fireEvent('beforechange', me, current) !== false) {
                                                    ...
                                                    var main = Ext.getCmp('NFW2_monitor_antivirus');
    ...
    onUpdate_chkChange: function(field, newValue, oldValue, eOpts) {
        var me = Ext.getCmp('NFW2_monitor_antivirus');
