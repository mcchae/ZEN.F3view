...
Ext.define('NFW2.view.NFW2_log_logSearch_ddos', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_log_logsearch_ddos',

    requires: [
        'NFW2.view.NFW2_log_logSearch_ddosViewModel',
        'Ext.form.Panel',
        'Ext.form.Label',
        'Ext.button.Button',
        'Ext.form.field.Date',
    ...
    onButtonClick: function(button, e, eOpts) {
        ...
        var store = Ext.data.StoreManager.lookup('store_log_ddos');
        ...
        _search_params['schema_name'] = Ext.encode('DDOS');
        ...
        if(Ext.getCmp("dis_mode").getValue() === "display"){
            ...
            var fileName = Ext.Date.format(new Date(), 'Ymd')+"_DDOS.xlsx";
            var path = '/mnt/ramdisk/do/F3view/nodeapps/deploy/public/javascripts/attachments/';

            var _condition = {
                schema_name: Ext.encode('DDOS'),
    ...
    onPanelAfterRender: function(component, eOpts) {
        ...
        request_helper.xmlrpc_call_JsonP(
            ...
            function(response){
                ...
                var r_event = [];
                var a_list = ["DoS","DDoS","HTTP","DNS","SQL"];
                var _a_list = ['dos','ddos','http','dns','sql'];
