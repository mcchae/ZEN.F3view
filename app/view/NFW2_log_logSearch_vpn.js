...
Ext.define('NFW2.view.NFW2_log_logSearch_vpn', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_log_logsearch_vpn',

    requires: [
        'NFW2.view.NFW2_log_logSearch_vpnViewModel',
        'Ext.form.Panel',
        'Ext.form.Label',
        'Ext.button.Button',
        'Ext.form.field.Date',
    ...
    onButtonClick: function(button, e, eOpts) {
        ...
        var store = Ext.data.StoreManager.lookup('store_log_vpn');
        ...
        _search_params['schema_name'] = Ext.encode('VPN');
        ...
        if(Ext.getCmp("dis_mode").getValue() === "display"){
            ...
            var fileName = Ext.Date.format(new Date(), 'Ymd')+"_VPN.xlsx";
            var path = '/mnt/ramdisk/do/F3view/nodeapps/deploy/public/javascripts/attachments/';

            var _condition = {
                schema_name: Ext.encode('VPN'),
    ...
    onPanelAfterRender: function(component, eOpts) {
        ...
        var _params = {
            ...
            cond: Ext.encode({'category':'IPSecVPN'})
        };
        ...
        request_helper.xmlrpc_call_JsonP(
            ...
            function(response){
                ...
                var r_event = [];
                var a_list = ["IKE","IPSec"];
                var _a_list = ['ike','ipsec'];
