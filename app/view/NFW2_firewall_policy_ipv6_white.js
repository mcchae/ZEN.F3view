...
Ext.define('NFW2.view.NFW2_firewall_policy_ipv6_white', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.NFW2_firewall_policy_ipv6_white',

    requires: [
        'NFW2.view.NFW2_firewall_policy_ipv6_whiteViewModel',
    ...
    viewModel: {
        type: 'nfw2_firewall_policy_ipv6_white'
    },
    cls: 'zen_body',
    id: 'white_black_ip',
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    listeners: {
                        errorchange: 'onW_search_ipv6ErrorChange',
                        keydown: 'onW_search_ipv6Keydown',
                        render: 'onW_search_ipv6Render'
                    }
                },
                {
                    xtype: 'button',
                ...
                },
                {
                    ...
                    enableKeyEvents: true,
                    listeners: {
                        keydown: 'onW_search_desc_v6Keydown',
                        render: 'onW_search_desc_v6Render'
                    }
                },
                {
                    xtype: 'button',
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                xtype: 'displayfield',
                                id: 'zen_fw_white_ipv6_disp_total',
                                labelAlign: 'right',
                                labelSeparator: ' ',
                                labelWidth: 90,
                    ...
                    },
                    {
                        ...
                        listeners: {
                            celldblclick: 'onW_tbl_listv6CellDblClick'
                        }
                    }
                ]
            };
    ...
    onButtonClick2: function(button, e, eOpts) {
        ...
        var tbl = Ext.getCmp("w_tbl_listv6");
    ...
    onButtonClick3: function(button, e, eOpts) {
        ...
        Ext.MessageBox.confirm(__weguardia,get_msg('conf_del_all'), function(btn){
            if(btn === "yes"){
                ...
                var _param = {
                    basename: Ext.encode("network_white_black_ip"),
                    key: Ext.encode({'type':'white','ip_ver':'ipv6'})
                };
    ...
    onButtonClick7: function(button, e, eOpts) {
        ...
        var fileName = "WeGuardia_White_IPv6";
        ...
        var _params = {
            ...
            cond: Ext.encode({'type':'white','ip_ver':'ipv6'}),
            ...
            form.submit({
                ...
                success: function(fp, o) {
                    ...
                    var _params = {
                        ...
                        opt: Ext.encode({'type':'white','ip_ver':'ipv6'})
                    };
                    showLoadMask();
    ...
    onW_search_ipv6ErrorChange: function(labelable, error, eOpts) {
        prt_errMsg_label(error,'err_valid');
    },

    onW_search_ipv6Keydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            var ip = textfield;
            ...
            _store.getProxy().setExtraParam('cond',Ext.encode({'ip_ver':'ipv6','type':'white'}));
            ...
            Ext.getCmp("w6_reset").show();
        }
    },

    onW_search_ipv6Render: function(component, eOpts) {
        component.emptyText = __zen('ipv6');
        component.applyEmptyText();
    },

    onButtonClick: function(button, e, eOpts) {
        var ip = Ext.getCmp("w_search_ipv6");
    ...
    onW_search_desc_v6Keydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            var desc = textfield;
            ...
            _store.getProxy().setExtraParam('cond',Ext.encode({'ip_ver':'ipv6','type':'white','desc':{'$regex':'.*'+desc.getValue()+'.*','$options':'imxs'}}));
            _store.getProxy().setExtraParam('sort_list',Ext.encode([['ip_first',1],['ip_last',1]]));
            _store.loadPage(1);
    ...
    onW_search_desc_v6Render: function(component, eOpts) {
    ...
    onButtonClick4: function(button, e, eOpts) {
        ...
        Ext.getCmp("w_search_ipv6").reset();
        Ext.getCmp("w_search_desc_v6").reset();

        Ext.getCmp("w6_reset").hide();
    },

    onW_tbl_listv6CellDblClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        var win = Ext.create("NFW2.view.win_white_black_ip",{
            edit: "edit",
            type_wb : "White",
            type : "IPv6",
    ...
    fm_reset: function() {
        Ext.getCmp("fm_white_v6").getForm().reset();
    },
            ...
            function(response){
                ...
                request_helper.xmlrpc_call_JsonP(
                    ...
                    function(response){
                        ...
                        if(max_count){
                            Ext.getCmp("zen_fw_white_ipv6_disp_total").setValue(response.total+'/'+max_count);
                        }
                    }
                );
            }
