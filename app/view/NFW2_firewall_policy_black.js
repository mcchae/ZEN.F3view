...
Ext.define('NFW2.view.NFW2_firewall_policy_black', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nfw2_firewall_policy_black',

    requires: [
        'NFW2.view.NFW2_firewall_policy_blackViewModel',
    ...
    viewModel: {
        type: 'nfw2_firewall_policy_black'
    },
    cls: 'zen_body',
    id: 'white_black_ip',
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    listeners: {
                        errorchange: 'onB_search_ipv4ErrorChange',
                        keydown: 'onB_search_ipv4Keydown',
                        render: 'onB_search_ipv4Render'
                    }
                },
                {
                    xtype: 'button',
                ...
                },
                {
                    ...
                    enableKeyEvents: true,
                    listeners: {
                        keydown: 'onB_search_desc_v4Keydown',
                        render: 'onB_search_desc_v4Render'
                    }
                },
                {
                    xtype: 'button',
    ...
    onButtonClick2: function(button, e, eOpts) {
        ...
        var tbl = Ext.getCmp("b_tbl_listv4");
    ...
    onButtonClick3: function(button, e, eOpts) {
        ...
        Ext.MessageBox.confirm(__weguardia,get_msg('conf_del_all'), function(btn){
            if(btn === "yes"){
                ...
                var _param = {
                    basename: Ext.encode("network_white_black_ip"),
                    key: Ext.encode({'type':'black','ip_ver':'ipv4'})
                };
    ...
    onButtonClick7: function(button, e, eOpts) {
        ...
        var fileName = "WeGuardia_Black_IPv4";
        ...
        var _params = {
            ...
            cond: Ext.encode({'type':'black','ip_ver':'ipv4'}),
            ...
            form.submit({
                ...
                success: function(fp, o) {
                    ...
                    var _params = {
                        ...
                        opt: Ext.encode({'type':'black','ip_ver':'ipv4'})
                    };
                    showLoadMask();
    ...
    onB_search_ipv4ErrorChange: function(labelable, error, eOpts) {
        prt_errMsg_label(error,'err_valid');
    },

    onB_search_ipv4Keydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            var ip = Ext.getCmp("b_search_ipv4");
            ...
            _store.getProxy().setExtraParam('cond',Ext.encode({'ip_ver':'ipv4','type':'black'}));
            ...
            Ext.getCmp("b4_reset").show();
        }
    },

    onB_search_ipv4Render: function(component, eOpts) {
    ...
    onB_search_desc_v4Keydown: function(textfield, e, eOpts) {
        if(e.getCharCode() === 13){
            var desc = textfield;
            ...
            _store.getProxy().setExtraParam('cond',Ext.encode({'ip_ver':'ipv4','type':'black','desc':{'$regex':'.*'+desc.getValue()+'.*','$options':'imxs'}}));
            _store.getProxy().setExtraParam('sort_list',Ext.encode([['ip_first',1],['ip_last',1]]));
            _store.loadPage(1);
    ...
    onB_search_desc_v4Render: function(component, eOpts) {
        component.emptyText = __zen('desc');
        component.applyEmptyText();
    },

    onButtonClick1: function(button, e, eOpts) {
        var desc = Ext.getCmp("b_search_desc_v4");
    ...
    onButtonClick4: function(button, e, eOpts) {
        ...
        Ext.getCmp("b_search_ipv4").reset();
        Ext.getCmp("b_search_desc_v4").reset();

        Ext.getCmp("b4_reset").hide();
    },
    ...
    fm_reset: function() {
        Ext.getCmp("fm_black_v4").getForm().reset();
    },
            ...
            function(response){
                ...
                request_helper.xmlrpc_call_JsonP(
                    ...
                    function(response){
                        ...
                        if(max_count){
                            Ext.getCmp("zen_fw_black_disp_total").setValue(response.total+'/'+max_count);
                        }
                    }
                );
            }
